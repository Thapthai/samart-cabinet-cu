...
export default function StaffUsersFilterSection({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl border border-pink-200/80 bg-gradient-to-br from-pink-50/50 via-white to-rose-50/40 p-1 shadow-sm shadow-pink-200/40",
        "ring-offset-background transition-shadow focus-within:ring-2 focus-within:ring-pink-500/20 focus-within:ring-offset-2",
      )}
    >
      <div className="space-y-5 rounded-xl bg-white/90 px-3 py-4 sm:px-5 sm:py-5 backdrop-blur-sm">
        <div className="flex gap-3">
          <div
            className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-pink-500 to-rose-500 text-white shadow-md shadow-pink-500/25"
            aria-hidden
          >
        ...
        <div className="flex flex-col-reverse gap-2 pt-1 sm:flex-row sm:justify-end sm:gap-3">
          ...
          <Button
            type="button"
            onClick={handleApply}
            className="h-10 min-w-[120px] rounded-xl bg-gradient-to-r from-pink-500 to-rose-500 px-4 font-medium text-white shadow-md shadow-pink-500/20 hover:from-pink-600 hover:to-rose-600"
          >
            ค้นหา
          </Button>
        </div>
